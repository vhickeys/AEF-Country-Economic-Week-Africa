<!-- Preloader Start -->
{{-- <div class="preloader lwr-loading">
    <div class="lwr-loader"></div>
</div> --}}
<!-- Preloader End -->

<!-- back to top start -->
{{-- <div class="back-to-top-wrapper">
    <button id="back_to_top" type="button" class="back-to-top-btn back-to-top-btn-lwr">
    ...
    <div class="tp-offcanvas-wrapper">
        <div class="tp-offcanvas-top d-flex align-items-center justify-content-between">
            <div class="tp-offcanvas-logo">
                <a href="{{ route('homepage') }}">
                    <img data-width="100" src="{{ asset('assets/img/aef-cewa/logo/logo.png') }}" alt="Africa CEO Council">
                </a>
            </div>
        ...
        <div class="tp-offcanvas-main">
            <div class="tp-offcanvas-content">
                <h3 class="tp-offcanvas-title">{{ config('app.name') }}</h3>
                <p>The AEF Country Economic Week Africa aims to provide in-depth analysis and insights on one African economy at a time, focusing on key economic trends, opportunities, and challenges.</p>
            </div>
            ...
            <div class="tp-offcanvas-contact">
                ...
                <ul>
                    <li><a href="tel:+2348105043535">+234 810 504 3535</a></li>
                    <li><a href="mailto:info@aefgroup.org">info@aefgroup.org</a></li>
                    <li><a href="#">F.C.T Abuja, Nigeria</a></li>
                </ul>
            </div>
